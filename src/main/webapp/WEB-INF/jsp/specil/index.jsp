...
<head>
    ...
    <script src="<c:url value="/customer/js/specilIndex.js"/>"></script>
                                            ...
                                            <c:otherwise>
                                                <div class="col-md-12">
                                                    <c:if test="${pageResult.page > 1}">
                                                        <li><a href="/specil/index/1/8.html" target="_self">首页</a></li>
                                                        <li><a href="/specil/index/${pageResult.page - 1}/8.html" target="_self">上一页</a></li>
                                                    </c:if>
                                                    <c:forEach var="page" begin="1" end="${pageResult.totalPage}">
                                                        <li><a href="/specil/index/${page}/8.html" target="_self">${page}</a></li>
                                                    </c:forEach>
                                                    <c:if test="${pageResult.totalPage > pageResult.page}">
                                                        <li><a href="/specil/index/${pageResult.page + 1}/8.html" target="_self">下一页</a></li>
                                                        <li><a href="/specil/index/${pageResult.totalPage}/8.html" target="_self">末页</a></li>
                                                    </c:if>
                                                </div>
                                            </c:otherwise>
                                        </c:choose>
