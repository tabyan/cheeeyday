 ...
 */
public class Chinese_24SolarTerms {
...
//注意：凡闰年3月1日前闰年数要减一，即：L=[(Y-1)/4],因为小寒、大寒、立春、雨水这两个节气都小于3月1日,所以 y = y-1
    ...
    public static List<TraditionalChineseDay> solarTermToString(int year) {
        List<TraditionalChineseDay> list = new ArrayList<TraditionalChineseDay>();
        ...
        TraditionalChineseDay traditionalChineseDay = new TraditionalChineseDay();
        String dateString = "";
        Date date;

        traditionalChineseDay.setName("立春");
        dateString = year+"-02-"+getSolarTermNum(year,SolarTermsEnum.LICHUN.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("雨水");
        dateString = year+"-02-"+getSolarTermNum(year,SolarTermsEnum.YUSHUI.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("惊蛰");
        dateString = year+"-03-"+getSolarTermNum(year,SolarTermsEnum.JINGZHE.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("春分");
        dateString = year+"-03-"+getSolarTermNum(year,SolarTermsEnum.CHUNFEN.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("清明");
        dateString = year+"-04-"+getSolarTermNum(year,SolarTermsEnum.QINGMING.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("谷雨");
        dateString = year+"-04-"+getSolarTermNum(year,SolarTermsEnum.GUYU.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("立夏");
        dateString = year+"-05-"+getSolarTermNum(year,SolarTermsEnum.LIXIA.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();
        ...
        traditionalChineseDay.setName("小满");
        dateString = year+"-05-"+getSolarTermNum(year,SolarTermsEnum.XIAOMAN.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("芒种");
        dateString = year+"-06-"+getSolarTermNum(year,SolarTermsEnum.MANGZHONG.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("夏至");
        dateString = year+"-06-"+getSolarTermNum(year,SolarTermsEnum.XIAZHI.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("小署");
        dateString = year+"-07-"+getSolarTermNum(year,SolarTermsEnum.XIAOSHU.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("大署");
        dateString = year+"-07-"+getSolarTermNum(year,SolarTermsEnum.DASHU.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("立秋");
        dateString = year+"-08-"+getSolarTermNum(year,SolarTermsEnum.LIQIU.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("处署");
        dateString = year+"-08-"+getSolarTermNum(year,SolarTermsEnum.CHUSHU.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("白露");
        dateString = year+"-09-"+getSolarTermNum(year,SolarTermsEnum.BAILU.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("秋分");
        dateString = year+"-09-"+getSolarTermNum(year,SolarTermsEnum.QIUFEN.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("寒露");
        dateString = year+"-10-"+getSolarTermNum(year,SolarTermsEnum.HANLU.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("霜降");
        dateString = year+"-10-"+getSolarTermNum(year,SolarTermsEnum.SHUANGJIANG.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("立冬");
        dateString = year+"-11-"+getSolarTermNum(year,SolarTermsEnum.LIDONG.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("小雪");
        dateString = year+"-11-"+getSolarTermNum(year,SolarTermsEnum.XIAOXUE.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("大雪");
        dateString = year+"-12-"+getSolarTermNum(year,SolarTermsEnum.DAXUE.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("冬至");
        dateString = year+"-12-"+getSolarTermNum(year,SolarTermsEnum.DONGZHI.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();

        traditionalChineseDay.setName("小寒");
        dateString = year+"-01-"+getSolarTermNum(year,SolarTermsEnum.XIAOHAN.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();
        ...
        traditionalChineseDay.setName("大寒");
        dateString = year+"-01-"+getSolarTermNum(year,SolarTermsEnum.DAHAN.name());
        date = DateTimeUtils.stringToDate(dateString);
        traditionalChineseDay.setChinesedayTime(date);
        list.add(traditionalChineseDay);
        traditionalChineseDay = new TraditionalChineseDay();
    ...
    public static void main(String[] args) {
        for(int year=1901;year<2050;year++){
            List<TraditionalChineseDay> list = solarTermToString(year);
            System.out.println("-----------------------------------------------------");
