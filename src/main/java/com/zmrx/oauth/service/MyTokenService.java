...
public class MyTokenService implements AuthorizationServerTokenServices, ResourceServerTokenServices, ConsumerTokenServices, InitializingBean {
    ...
    private int accessTokenValiditySeconds = 10000;             //access_token 的超时时间   默认12个小时
    private boolean supportRefreshToken = true;            //是否支持access_token 刷新，默认是false,在配置文件中以配置成可以支持了，
